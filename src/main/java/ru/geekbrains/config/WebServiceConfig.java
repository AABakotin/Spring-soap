...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public ServletRegistrationBean<MessageDispatcherServlet> messageDispatcherServlet(ApplicationContext applicationContext) {
        ...
        return new ServletRegistrationBean<>(servlet, "/geekbrains/*");
    }
    ...
    public DefaultWsdl11Definition categoriesWsdl11Definition(XsdSchema categoriesSchema) {
        ...
        wsdl11Definition.setLocationUri("/geekbrains");
        wsdl11Definition.setTargetNamespace("http://www.geekbrains.ru/categories");
    ...
    public DefaultWsdl11Definition productsWsdl11Definition(XsdSchema productsSchema) {
        ...
        wsdl11Definition.setLocationUri("/geekbrains");
        wsdl11Definition.setTargetNamespace("http://www.geekbrains.ru/products");
